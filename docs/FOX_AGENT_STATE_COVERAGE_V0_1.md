...
android/app/src/main/assets/mascot/xiaobaohu/v1/*/v*/frames/*.png
...
每个状态的主 manifest 条目、子 manifest、`framePattern` 和 24 帧 PNG 均已静态核对。
